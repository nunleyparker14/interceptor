...
class DrawMav:
    ...
    def get_points(self):
        ...
        meshColors[4] = blue   # body-top
        meshColors[5] = blue   # body-portside
        meshColors[6] = blue   # body-starboard side
        meshColors[7] = blue   # body-bottom
        meshColors[8] = green # wing-back
        meshColors[9] = green # wing-front
        meshColors[10] = green # tailwing-back
        meshColors[11] = green # tailwing-front
