...
######################################################################################
                #   Initial Conditions
######################################################################################
#   Initial conditions for INTERCEPTOR
interceptor_north0 = np.random.randint(0, 101)  # Random integer between 0 and 100 for north coordinate
interceptor_east0 = np.random.randint(0, 101)   # Random integer between 0 and 100 for east coordinate
north0 = -3000 # interceptor_north0  # initial north position
east0 = 0 # interceptor_east0   # initial east position
