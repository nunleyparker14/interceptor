...
class Plotter():
    def __init__(self, app, plots_per_row, window_width=800,
                  window_height=1000):
        self._app = app
    ...
    def show_window(self, x_position=800, y_position=0, sleep_time=0):
        self._window.move(x_position, y_position)  # Set the position of the window
        self.update_plots()
        self._window.show()
